<?php
	...
	$post_sql = "SELECT `post_id`, `user_id`, `type`, `series`, `course_id`, `content`, `file_title` FROM `posts`";
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../assets/css/student/student.css">
